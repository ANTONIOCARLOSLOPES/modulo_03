...
class MoedasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create moeda" do
    assert_difference('Moeda.count') do
      post moedas_url, params: { moeda: { acronym: @moeda.acronym, description: @moeda.description, url_image_string: @moeda.url_image_string } }
    end
  ...
  test "should update moeda" do
    patch moeda_url(@moeda), params: { moeda: { acronym: @moeda.acronym, description: @moeda.description, url_image_string: @moeda.url_image_string } }
